...
#'ggplot and ggplot2::geom_point.
#'The estimated difference is plotted on the x-axis and the negative 10-log
#'p-value on the y-axis.
#'The horizontal dotted line indicates p-value=0.05.
#'Dots are colored based on the Benjamini-Hochberg adjusted p-value cutoff 0.05
#'and can optionally be annotated by OlinkID.
#'
  ...
  if (length(list(...)) > 0) {
    ...
    if (length(ellipsis_variables) == 1) {
      ...
      if (!(ellipsis_variables == "coloroption")) {
        ...
        cli::cli_abort(paste0("The ... option only takes the coloroption",
                              " argument. ... currently contains the variable ",
                              ellipsis_variables,
                              "."))
      ...
      cli::cli_abort(paste0("The ... option only takes one argument.",
