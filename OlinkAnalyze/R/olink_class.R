...
#'
#' @param df A tibble or ArrowObject containing Olink NPX data.
#' @param check_log An optional named list returned by [`check_npx()`]. If not
#' provided, the check log will be generated by calling [`check_npx()`]
#' internally using the provided `df` and `preferred_names`.
