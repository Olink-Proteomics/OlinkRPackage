test_that("Data loads correctly with 'read_NPX()'", {
  ...
  expect_error(read_NPX(filename = zip_npx_file_fail_2), "The compressed file does not conatin a valid NPX file. Expecting: \"README.txt\", \"MD5_checksum.txt\" and the NPX file.")
