olink_wide_bottom_matrix <- dplyr::tribble(
  ...
  "Flex",          "NPX",        TRUE,            2L,       "PlateLOD",                  c("Plate LOD", "PlateLOD"),  # nolint
  ...
  "Flex",          "Quantified", TRUE,            0L,       "PlateLOD",                  c("Plate LOD", "PlateLOD"),  # nolint
  ...
  "Focus",         "NPX",        TRUE,            0L,       "PlateLOD",                  c("Plate LOD", "PlateLOD"),  # nolint
  ...
  "Focus",         "Quantified", TRUE,            0L,       "PlateLOD",                  c("Plate LOD", "PlateLOD"),  # nolint
  ...
  "Target 48",     "NPX",        TRUE,            2L,       "PlateLOD",                  c("Plate LOD", "PlateLOD"),  # nolint
  ...
  "Target 48",     "Quantified", TRUE,            0L,       "PlateLOD",                  c("Plate LOD", "PlateLOD"),  # nolint
  ...
  "Target 96",     "NPX",        FALSE,           3L,       "MaxLOD",                    c("Max LOD", "MaxLOD"),      # nolint
  "Target 96",     "NPX",        TRUE,            3L,       "PlateLOD",                  c("Plate LOD", "PlateLOD")   # nolint
)
