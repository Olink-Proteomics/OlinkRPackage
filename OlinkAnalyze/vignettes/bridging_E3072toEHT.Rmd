...
```{r echo=FALSE, post_bridging_3k_data , echo=FALSE}
npx_br_data |> 
...
```{r pca_pre_sc, echo=TRUE, fig.cap=f8, message=FALSE}
## Before Bridging
npx_br_data |> 
...
```{r pca_pre_bridge, echo=TRUE, fig.cap=f9, message=FALSE}
## Before Bridging
npx_br_data |> 
  dplyr::filter(SampleType == "SAMPLE") |> 
...
``` {r pca_post_SC, message=FALSE, echo = TRUE}
