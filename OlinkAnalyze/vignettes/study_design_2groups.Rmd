...
If you have more that two groups in your data, or a longitidual study see our other Study design vingettes. 
...
Looking at the example data two groups are found in the Treatment variable. Two distinct groups, Treated and Untreated exisit in this data. 
