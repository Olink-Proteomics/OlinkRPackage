...
header-includes:
  ...
  - \fancyhead[C]{\textbf{Bridging across NGS-based Olink\textsuperscript{®} products}}
  - \fancyhead[R]{\thepage}
...
```{r echo=FALSE, eval=TRUE, fig.cap=f3, out.width="90%"}
...
try( 
  readRDS(normalizePath("../man/figures/bridging_results.rds")) |> 
    ...
    kableExtra::column_spec(column = 1:21,width_max = "5em")
)
```
...
try( 
  readRDS(normalizePath("../man/figures/bridging_results.rds")) |> 
    ...
    kableExtra::scroll_box(width = "100%") |> 
    kableExtra::column_spec(column = 1:19,width_max = "5em")
)
```
