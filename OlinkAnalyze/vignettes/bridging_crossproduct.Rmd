...
```{r echo=FALSE, eval=TRUE, fig.cap=f3, fig.height= 8, fig.width= 6}
...
```{r echo=FALSE, fig.cap=fcap, out.width="\\linewidth"}
...
```{r message=FALSE, echo = FALSE, out.width = "\\linewidth", fig.cap = fcap}
