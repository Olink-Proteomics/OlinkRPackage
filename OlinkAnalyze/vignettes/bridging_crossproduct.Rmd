...
try( 
  readRDS(normalizePath("../man/figures/bridging_results.rds")) |> 
    ...
    kableExtra::kbl(booktabs = TRUE,
                    linesep = "",
                    digits = 1,
                    caption = "First 5 rows of combined datasets after bridging with between-product formatting argument set to FALSE.") |>
    kableExtra::kable_styling(bootstrap_options = "striped", 
                              full_width = FALSE,
...
try( 
  readRDS(normalizePath("../man/figures/bridging_results.rds")) |> 
    ...
    kableExtra::kbl(booktabs = TRUE,
                    linesep = "",
        digits = 1,
        caption = "First 5 rows of combined datasets after bridging with between-product formatting argument set to TRUE.") |>
