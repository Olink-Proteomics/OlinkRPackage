...
Data from Explore 3072 and the reference project will be concatenated in the function export. Two additional columns are added to aid in data mapping and export. 
