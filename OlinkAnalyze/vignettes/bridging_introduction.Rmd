...
then determine the success of the bridging process post bridging. Figure 2 shows a large overlap between data1 and data2, however there are still some differences as indicated by the bly and red areas on the edge of the distribution.
...
npx_br_data %>% 
  kableExtra::kbl(booktabs = TRUE,
      digits = 1,
      caption = "Table 4. Combined datasets after bridging.") %>%
...
projects is to calculate the CV of the control samples before and after bridging the projects, as shown in Figure 7. The CV after normalization is expected to be smaller than the CV prior to normalization, as shown in Figure 7. 
