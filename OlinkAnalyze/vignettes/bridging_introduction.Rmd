...
(`npx_data1` and `npx_data2`) from **Olink Analyze** package. 
This workflow also uses functions from the dplyr, stringr, and ggplot2 packages.
...
The other dataset is considered the new dataset (`df2`) and is adjusted to 
...
which dataset is the reference dataset and specify the names of the bridge samples.
