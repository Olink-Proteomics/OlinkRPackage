...
It's important to make sure that the select bridge samples are representative of the overall samples. This can be done with the following code and make sure that the bridge samples are clustered with the remaining samples. 
