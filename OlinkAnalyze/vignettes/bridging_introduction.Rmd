...
using `read_NPX()` function with NPX manager output file as input.
...
Explore and have an overview of the datasets that are going to be
bridged. For example, plot and compare NPX distribution between
datasets.
...
the names of the bridge samples.
