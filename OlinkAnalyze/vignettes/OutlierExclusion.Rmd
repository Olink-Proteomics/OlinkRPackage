...
knitr::include_graphics(normalizePath("../man/figures/PCA_Panel.png"))
```
...
knitr::include_graphics("../man/figures/Outlier_PCA.png")
```
...
knitr::include_graphics("../man/figures/label_samples_pca.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../man/figures/dist_boxplot.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("../man/figures/site_boxplot.png")
```
