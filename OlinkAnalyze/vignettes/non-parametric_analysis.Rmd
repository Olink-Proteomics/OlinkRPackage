...
Mann-Whitney U Test (Wilcoxon Rank-Sum Test): Used to compare two independent groups to determine if there is a significant difference between them.

Wilcoxon Signed-Rank Test: Used to compare two related (paired) samples to determine if there is a significant difference between them.
...
In this example we will demonstrate how to perform different non-parametric tests using `npx_data1` which will act as the reference data. 
...
wilcox_results %>% 
  ...
  kableExtra::kbl(booktabs = TRUE,
      digits = 1,
      caption = "Table 4. First 10 rows of Mann-Whitney U Test results.") %>%
...
wilcox_results_paired %>% 
  ...
  kableExtra::kbl(booktabs = TRUE,
      digits = 1,
      caption = "Table 4. First 10 rows of Wilcoxon Signed-Rank Test results.") %>%
  kableExtra::kable_styling(bootstrap_options = "striped", full_width = FALSE, font_size = 10, 
                position = "center", latex_options = "HOLD_position") %>% 
  kableExtra::scroll_box(width = "100%")
```
...
kruskal_results %>% 
  ...
  kableExtra::kbl(booktabs = TRUE,
      digits = 1,
      caption = "Table 4. First 10 rows of kruskal_results results.") %>%
  kableExtra::kable_styling(bootstrap_options = "striped", full_width = FALSE, font_size = 10, 
                position = "center", latex_options = "HOLD_position") %>% 
  kableExtra::scroll_box(width = "100%")
```
