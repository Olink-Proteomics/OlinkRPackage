...
header-includes:
  ...
  - \fancyhead[L]{\textbf{Calculating LOD from Olink\textsuperscript{®} Explore data}}
  # - \fancyhead[R]{\thepage}
...
technical evaluations of NPX™ datasets, such as calculating the Coefficient of Variation (CV). As a
...
table1 |> 
  kableExtra::kbl(booktabs = TRUE,
      linesep = "",
      digits = 2, caption = "Example results from Plate Control Normalized Project" ) |> 
...
table1 |>  
  ...
  kableExtra::kbl(booktabs = TRUE,
      linesep = "",
      digits = 2, caption = "Example results from Intensity Normalized Project") |> 
  kableExtra::kable_styling(font_size = 8, full_width = FALSE,
                  position = "center", latex_options = c("HOLD_position","scale_down"))
...
table1 |>  
  ...
  dplyr::select(SampleID, SampleType, OlinkID, UniProt, Assay, 
                Count, NPX, Normalization, PCNormalizedNPX, FixedLOD, 
                FixedPCNormalizedLOD, NCLOD, NCPCNormalizedLOD) |> 
  kableExtra::kbl(booktabs = TRUE,
      linesep = "",
      digits = 2,
  ...
  kableExtra::kable_styling(font_size = 11, full_width = TRUE,
                  position = "center", latex_options = c("HOLD_position","scale_down")) |> 
    kableExtra::column_spec(column = 1:13,width_max = "10em") 
