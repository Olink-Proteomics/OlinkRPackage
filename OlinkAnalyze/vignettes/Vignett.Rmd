...
* **QC_Warning** _\<chr\>_: Indication whether the sample passed Olink QC. More information about Olink quality control metrics can be found in our [FAQ](https://olink.com/knowledge/faq)
...
* QC_Warning: Indication whether the sample passed Olink QC. More information about Olink quality control metrics can be found in our [FAQ](https://olink.com/knowledge/faq). 
...
+ **ExtNPX** *<num>*: Extension normalized NPX value that is used in NPX calculation. Read more about ExtNPX in the [Olink FAQ]((https://olink.com/knowledge/faq)).
