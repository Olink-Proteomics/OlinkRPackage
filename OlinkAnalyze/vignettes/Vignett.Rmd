...
+ *bridgeable_plts* Function which generates plots that illustrate the three criteria for determining whether an assay is bridgeable in cross-product bridge normalizations
...
plot <- npx_data1_no_controls %>%
  na.omit() %>% # removing missing values which exist for Site
