...
entries removed according to the chosen arguments. Output matches that of the
function `read_npx()`.

**Note:** We recommend running `check_npx()` once again after cleaning the data
to confirm that all issues have been resolved and that the data is ready for
downstream analysis. A schematic illustration of the described workflow is
provided ([Olink Analyze v5.0 example workflow](#usage)).
