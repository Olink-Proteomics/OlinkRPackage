...
The input manifest should be a tibble/data frame in long format containing all sample ID's. Sample ID column must be named SampleID. An exsample manifest is shown in Table 1. 
